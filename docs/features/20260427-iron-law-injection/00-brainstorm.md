...
> **⚠️ 历史讨论记录（2026-04-27）**  
> 这是早期关于强制执行语言（Iron Law）的 brainstorming 讨论记录。  
> 相关功能已实现，但本文档保留作为设计讨论的历史参考。  
> 
> **当前请参考 `AGENTS.md` 和 `skills/` 中的最新实现。**
...
1. 当时那一版技能集中约 10 个是"刚性纪律"技能（TDD、Debug、Review、Security、Ship 等），需要 Iron Law 级别的行为塑造
