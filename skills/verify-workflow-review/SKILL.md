...
- [ ] 构建成功
- [ ] Review Scope 已写清实际审查范围和未覆盖范围
- [ ] Evidence Reviewed 已记录测试、构建、预览、导出或人工验证证据
- [ ] Findings Detail 包含证据、影响、修复要求和复审状态
- [ ] Resolution & Re-review 已记录修复/延期问题和复审证据
- [ ] Residual Risk 已记录可接受风险和 follow-up owner
