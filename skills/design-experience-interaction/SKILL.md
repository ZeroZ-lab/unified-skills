...
先读取 `references/design-best-practices.md`，并把交互相关证据写入 `02-design.md` 的 `Design References / Pattern Synthesis / Adopt / Reject`。
...
- Local Project Truth: 现有路由、组件库、用户权限、数据可用性和业务边界
