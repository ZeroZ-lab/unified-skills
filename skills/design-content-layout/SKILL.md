...
先读取 `references/design-best-practices.md`，并把排版相关证据写入 `02-design.md` 的 `Design References / Pattern Synthesis / Adopt / Reject`。
...
- Local Project Truth: 当前模板、素材比例、内容长度、输出格式和安全边距
