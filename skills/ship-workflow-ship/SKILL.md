...
description: 预发检查 → Go/No-Go → 回滚计划 → 文档聚合。使用 cuando 审查通过需要上线
---

# Ship — 部署上线

> 来源: agent-skills shipping-and-launch + gstack /ship | 宪法: 第 5（Verify Don't Assume）、第 9（Every Feature Leaves a Trace）条
